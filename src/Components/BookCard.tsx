...
export default function BookCard(book: Book) {
    return (
        <div key={book.id} className="flex flex-col h-120 items-center rounded-2xl justify-center px-4 py-4 border-2 border-neutral-200 hover:bg-white duration-200">
...
function SmallBookCard(book: Book) {
    return (
        <div key={book.id} className="flex h-60 w-90 items-center rounded-2xl justify-center px-4 py-4 border-2 border-neutral-200 hover:bg-white duration-200">
